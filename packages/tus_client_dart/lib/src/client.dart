  ...
  Future<void> createUpload() async {
    ...
    try {
      ...
      if (!(response.statusCode >= 200 && response.statusCode < 300) && response.statusCode != 404) {
        ...
        throw ProtocolException("Unexpected Error while creating upload", response.statusCode);
      }
    ...
    while (!_pauseUpload && _offset < totalBytes) {
      ...
      if (_response != null) {
        ...
        if (serverOffset == null) {
          throw ProtocolException("Response to PATCH request contains no or invalid Upload-Offset header");
        }
  ...
  Future<void> cancelUpload() async {
    try {
      ...
      if (response.statusCode != 204) {
        throw ProtocolException("Error cancelling upload", response.statusCode);
      }
